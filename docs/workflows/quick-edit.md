...
## When to use it
- Your chapters are mostly right; you just want to tidy up titles or tweak a timestamp.
- You want to use [AI Cleanup](../editor/ai-cleanup.md) to reformat or normalize titles.
- You need to add one or two absent chapters. See [Fill in a few missing chapters](../examples/fill-missing-chapters.md).
- You want to export the existing chapter data as CSV/JSON/CUE without changing anything.
...
- [Fill in a few missing chapters](../editor/add-chapter-dialog.md)
- [Free options for AI Cleanup](../editor/ai-cleanup.md)
- [Chapter Editor overview](../editor/overview.md)
