...
Task-focused walkthroughs for common scenarios. For feature-by-feature reference, see the [Chapter Editor](../editor/overview.md) section; for workflow-level documentation, see [Workflows](../workflows/index.md).

- [Start from scratch with Smart Detect](start-from-scratch-with-smart-detect.md): Build chapters from the audio itself.
- [Create titles from audio files](create-titles-from-audio-files.md): Transcribe real titles for a multi-file book.
