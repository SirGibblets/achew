...
![Upgrade Available](../img/update-available-dark.webp#only-dark){ width="140" align=left .off-glb }
![Upgrade Available](../img/update-available-light.webp#only-light){ width="140" align=left .off-glb }
