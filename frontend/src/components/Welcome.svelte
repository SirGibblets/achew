<script lang="ts">
  ...
  let { onwelcomedismissed }: Props = $props();
...
<div class="welcome-container">
  ...
  <p class="intro">
    To get started, you'll need to connect Achew to your Audiobookshelf server. You can then optionally configure an LLM
    provider for AI-powered cleanup.
  </p>

  <div class="welcome-actions">
    <button class="btn btn-verify" onclick={handleGetStarted} disabled={loading}>
      Get Started
      <ArrowRight size="18" />
    </button>
  </div>
