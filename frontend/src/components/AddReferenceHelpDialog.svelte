...
{#if isOpen}
  <div class="backdrop" onclick={close} role="presentation">
    ...
    ...etc...
        ...
        <p>
          <span class="section-title">*Library Files</span> are files stored in the same directory as your audiobook
          file(s). These can be viewed in the <em>Library Files</em> section of the book's detail page in Audiobookshelf.
        </p>

        <p>
          <span class="section-title">**Timestamps</span> in JSON and CSV files can be in any of these formats:
        </p>
        <ul>
          <li>
            <code>H:MM:SS</code> or <code>H:MM:SS.ms</code> — e.g. <code>1:02:34</code> or
            <code>1:02:34.500</code>
          </li>
          <li>
            <code>M:SS</code> or <code>M:SS.ms</code> — e.g. <code>62:34</code> or <code>62:34.500</code>
          </li>
